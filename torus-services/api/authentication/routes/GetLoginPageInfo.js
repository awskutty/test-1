...
var serviceName = 'GetLoginPageInfo';

// Host api to server
router.post('/GetLoginPageInfo', function (appRequest, appResponse, next) {
    var objLogInfo;
    try {
        ...
        reqLogInfo.AssignLogInfoDetail(appRequest, function (objLogInfo, objSessionInfo) {
            try {
                ...
                //objLogInfo.HANDLER_CODE = 'GetLoginPageInfo';
                ...
                reqLoginPageHelper.GetLoginPageInfo(params, headers, objLogInfo, function (error, result) {
                    try {
                        if (error) {
